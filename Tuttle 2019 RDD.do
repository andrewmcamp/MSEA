...
* Try doing the same for bandwidths of 120, 180, and 240 days. Follow the bw_XXX format for storing results
...
* Let's try estimating treatment effects using ivregress.
